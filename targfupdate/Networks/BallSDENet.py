...
class ScoreMLP(nn.Module):
    def __init__(self, marginal_prob_std_func, n_box, mode, device, hidden_dim=64, embed_dim=32, reference=2):
        ...
        self.l1 = nn.Sequential(
            nn.Linear(reference, hidden_dim),
            nn.ReLU(True),
            nn.Linear(hidden_dim, hidden_dim),
            nn.ReLU(True),
            nn.Linear(hidden_dim, hidden_dim),
