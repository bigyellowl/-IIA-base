...
for i in range(1000):
    ...
    a[i][11]=1.0
    a[i][12] = float(a[i][L[1]*3] +r5*math.cos(theta5))
    a[i][13] = float(a[i][L[1]*3+1]+ r5*math.sin(theta5))
    a[i][14]=1.0
    ...
    a[i][18] = float(a[i][L[0]*3] +r1*math.cos(theta1))
    a[i][19] = float(a[i][L[0]*3+1]+ r1*math.sin(theta1))
    a[i][20]=2.0
    a[i][21] = float(a[i][L[1]*3] +r2*math.cos(theta2))
    a[i][22] = float(a[i][L[1]*3+1]+ r2*math.sin(theta2))
    a[i][23]=2.0
    a[i][24] = float(a[i][L[2]*3] +r3*math.cos(theta3))
    a[i][25] = float(a[i][L[2]*3+1]+ r3*math.sin(theta3))
    a[i][26]=2.0
    a[i][27] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][28] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][29]=2.0
    a[i][30] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][31] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][32]=2.0

print(a[:2][:])
with open('cluster3_more.pkl', 'wb') as f:
    pickle.dump(a, f)