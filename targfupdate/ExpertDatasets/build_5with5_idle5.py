...
for i in range(1000):
    ...
    a[i][32]=2.0
    a[i][33] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][34] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][35]=2.0
    a[i][36] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][37] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][38]=2.0
    a[i][39] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][40] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][41]=2.0
    a[i][42] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][43] = float(random.uniform(-1+0.05, 1-0.05))
    a[i][44]=2.0

print(a[:2][:])
with open('5with5_idle5.pkl', 'wb') as f:
    pickle.dump(a, f)