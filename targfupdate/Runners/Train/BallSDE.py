...
if __name__ == '__main__':
    ...
    # train
    parser.add_argument('--n_epoches', type=int, default=15000)
    ...
    parser.add_argument('--num_objs', type=int, default=0)
    ...
    # dataset_path = f'./ExpertDatasets/lineup25_40.pkl'
    dataset_path = f'./ExpertDatasets/cluster2_more.pkl'
    # dataset_path = f'./ExpertDatasets/lineup_3_25.pkl'
    ...
    print(dataset.shape)
    print("--------------------")
    dataset = dataset.reshape(-1, dataset.shape[-1]) # useless
    print(dataset.shape)

    # prepare graph-based dataset
    k = num_objs - 1 # fully connected graph
    print(dataset[0].reshape(num_objs, 2+1)[:, :2])
